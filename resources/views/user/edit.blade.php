                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="book_past_holidays" name="book_past_holidays">
                                        <option @if($user->book_past_holidays === 0) selected @endif value="{{ old('book_past_holidays', '0') }}">No</option>
                                        <option @if($user->book_past_holidays === 1) selected @endif value="{{ old('book_past_holidays', '1') }}">Yes</option>
                                    </select>
                                </div>
                            </div>
